% Create Argus products from an example UAV video.
%
%
%
% Required inputs:
%   1. demoGCPFile
%   2. A UAV video which has been broken into images
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
display('Select directory that contains demoGCPFile.mat');
    gcpFileDir = uigetdir([],'Select directory that contains demoGCPFile.mat');
    inputs.gcpFn = [gcpFileDir,filesep,'demoUAVArgusGCPFile.mat'];
